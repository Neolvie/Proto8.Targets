...
from src.models.targets import GoalsMap, GoalNode
...
def _goal_context(goal: GoalNode, docx_content: Optional[str]) -> str:
    """
...
def _get_goal_or_raise(goals_map: GoalsMap, selected_goal_id: Optional[str]) -> GoalNode:
    """
